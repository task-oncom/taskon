...
use common\modules\testings\models\SearchSession;
...
class SessionAdminController extends AdminController
{
	...
	public function actionCreate()
	{
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $form = new \common\components\BaseForm('/common/modules/testings/forms/SessionForm', $model);
